...
<head>
    <meta charset="UTF-8">
    <title>Dio Albums Scatterplot | PopRock</title>
					...
					<ul class="navbar-nav mr-auto">
						...
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu">
								...
								<a class="dropdown-item active" href='https://roxorsoxor.com/poprock/scattercovers2.php'>Ronnie James Dio</a>
...
*/	
d3.json("data_text/dio-related-data/scatter_Dio_Albums.json", function(dataset) {
	...
	const artistTitle = d3.select("#name")
		                  .text("Ronnie James Dio's LastFM playcount as of December 1, 2019");
